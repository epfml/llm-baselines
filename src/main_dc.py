...
def main(args): 
    ...
    stats = train(model, opt, data, args.gamma, num_curated_seqs, args.num_rand_tok, args.data_seed, scheduler, args.iterations, args.acc_steps, args.batch_size, args.sequence_length, 
