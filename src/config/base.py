...
def parse_args(base_parser, args, namespace):
    ...
    parser.add_argument('--beta3', default=0.999, type=float) # used for ema
    parser.add_argument('--alpha', default=4, type=float) # adema 
    parser.add_argument('--scheduler', default='cos', choices=['linear', 'cos', 'none'])
    parser.add_argument('--opt', default='adamw', choices=['adamw', 'sgd','ademamix','muon','muonema'])
